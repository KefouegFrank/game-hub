...
<div class="platform-select">
  <div class="platform-buttons">
    <button type="button" class="platform-btn active" data-href="<?= htmlspecialchars(ONEXBET_WEBSITE_URL) ?>" data-media="/assets/img/apple-of-fortune.jpeg">
    ...
    <button type="button" class="platform-btn" data-href="<?= htmlspecialchars(ONEXBET_APP_URL) ?>" data-media="/assets/img/apple-of-fortune2.jpeg">
    ...
    <button type="button" class="platform-btn" data-href="<?= htmlspecialchars(MAILBET_WEBSITE_URL) ?>" data-media="/assets/img/apple-of-fortune.jpeg">
      <svg viewBox="0 0 24 24" fill="none" stroke="#38bdf8" stroke-width="1.6" aria-hidden="true"><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3c2.2 2.4 3.5 5.5 3.5 9s-1.3 6.6-3.5 9c-2.2-2.4-3.5-5.5-3.5-9s1.3-6.6 3.5-9Z" /></svg>
      MailBet <?= htmlspecialchars(t('website_label')) ?>
    </button>
    <button type="button" class="platform-btn" data-href="<?= htmlspecialchars(MAILBET_APP_URL) ?>" data-media="/assets/img/apple-of-fortune2.jpeg">
      <svg viewBox="0 0 24 24" fill="#3ddc84" aria-hidden="true">
        <path d="M7 10c0-2.8 2.2-5 5-5s5 2.2 5 5v4a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-4Z" />
        <circle cx="9.7" cy="10" r="0.9" fill="var(--bg)" />
        <circle cx="14.3" cy="10" r="0.9" fill="var(--bg)" />
      ...
      MailBet <?= htmlspecialchars(t('app_label')) ?>
    </button>
  </div>
  <button type="button" class="platform-btn platform-btn-wide" data-href="<?= htmlspecialchars(TUTORIAL_VIDEO_URL) ?>" data-media="/assets/img/apple-of-fortune.jpeg">
